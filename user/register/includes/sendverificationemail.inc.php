...
if (isset($_POST['signupsubmit'])) {
    ...
    $url = "http://webdev-marviniwurscht.servebeer.com/user/verify/includes/verify.inc.php?selector=" . $selector . "&validator=" . bin2hex($token);
    ...
    */
    ...
    try {
        ...
        // for public use
        //$_SESSION['STATUS']['loginstatus'] = '<div style="color: red">verification email could <b>NOT</b> be sent. <b>please contact the support.</b></div>';

        // for development use
        //$_SESSION['STATUS']['loginstatus'] = 'email could not be sent. ERROR: ' . $mail->ErrorInfo;
    }
