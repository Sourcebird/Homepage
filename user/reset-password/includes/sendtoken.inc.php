...
if (isset($_POST['resentsend'])) {
    ...
    */
    ...
    $url = "http://webdev-marviniwurscht.servebeer.com/user/reset-password/?selector=" . $selector . "&validator=" . bin2hex($token);
    ...
    */
    ...
    try {
        ...
        // for development use
        //$_SESSION['STATUS']['mailstatus'] = 'message could not be sent. ERROR: ' . $mail->ErrorInfo . '<br><br>' . $e->getMessage();
