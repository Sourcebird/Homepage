    ...
    */
    ...
    if ( $_SESSION['username'] != $username && !availableUsername($conn, $username)) {
        ...
        */
		...
		$OldPicture = $_SESSION['profile_image'];
            ...
            if (in_array($fileActualExt, $allowed))
            {
                if ($fileError === 0)
                {
                    if ($fileSize < 10000000)
                    {
                        ...
                        * -------------------------------------------------------------------------------
                        */
						if(!$OldPicture == '_defaultUser.png'){
							if (!unlink('../../assets/uploads/users/' . $OldPicture)) {  

								$_SESSION['ERRORS']['imageerror'] = 'old image could not be deleted '.$OldPicture;
								header("Location: ../");
								exit();
							} 
						} 
